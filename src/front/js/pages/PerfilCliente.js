...
const PerfilCliente = () => {
  ...
  console.log('hola soy el mns',user)
      ...
      {isLoggedIn && (<>
        <div className="parte-arriba">
          <div className="info-cliente">
            ...
            <img
              src={store.currentUser?.progress.photo_url || 'https://t4.ftcdn.net/jpg/01/17/48/95/360_F_117489540_elCLsL6KJwO3TvivV5n2NtGuUvR6RCEw.jpg'}
